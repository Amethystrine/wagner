...
void AddTriangleArea(void* funcparam, double coord[3][2], void* nodeparam[3]) {
...
void OutputForGnuplotWithLinesPoints(void* funcparam, double coord[2][2], void* nodeparam[2]) {
